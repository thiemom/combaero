...
class TestCompleteCombustion:
    ...
    def find_adiabatic_T_enthalpy_balance(
        self, gas, X_reactants, X_products, T_reactants, P, T_guess=2000.0, tol=0.1
    ):
    ...
    def test_methane_air_stoichiometric(
    ...
    def test_propane_air_stoichiometric(
        self, combaero, cantera, complete_combustion_gas, species_mapping, tolerance_config
    ):
