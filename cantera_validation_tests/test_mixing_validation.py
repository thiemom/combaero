...
class TestStreamMixing:
    ...
    def test_two_stream_mixing_equal_mass(self, combaero, cantera, gri30_gas, species_mapping, tolerance_config):
    ...
    def test_two_stream_mixing_unequal_mass(self, combaero, cantera, gri30_gas, species_mapping, tolerance_config):
    ...
    def test_three_stream_mixing(self, combaero, cantera, gri30_gas, species_mapping, tolerance_config):
    ...
    def test_enthalpy_conservation(self, combaero, cantera, gri30_gas, species_mapping, tolerance_config):
...
class TestDensityCalculation:
    ...
    def test_density_temperature_variation(self, combaero, cantera, gri30_gas, species_mapping, tolerance_config):
    ...
    def test_density_pressure_variation(self, combaero, cantera, gri30_gas, species_mapping, tolerance_config):
