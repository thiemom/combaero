...
from combaero.network.mpce_v2_element import MPCEv2Element  # noqa: E402
...
def _element(theta_deg: list[float], areas: list[float], joining: bool,
             alpha: float, eta: float) -> MPCEv2Element:
    ports = ["p0", "p1", "p2"]
    if joining:
...
def main() -> None:
    ...
    _OUT.write_text(
        ...
        "// port of MPCEv2Element, produced by the Python that ships.\n"
        "//\n"
