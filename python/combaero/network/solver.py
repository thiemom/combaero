        ...
        if success:
            ...
            if _bad_junctions:
                ...
                message = (
                    ...
                    "(wrong-direction port flow under a soft barrier, an "
                    "energy-inconsistent mirror root, or a state where the "
                    "junction's own loss closure is not net dissipative). "
                    "Treating as "
                    "non-converged; try "
